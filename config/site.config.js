module.exports = {
  ...
  footer:
    'Powered by duoxiaonian. <span id="busuanzi_container_site_pv">本站总访问量<span id="busuanzi_value_site_pv"></span>次</span>',
  ...
  protectedRoutes: ['/画师选集/胡麻乃りお/18+','/画师选集/Budesonide/18+','/画师选集/箩莉即正义/18+',
                   ...
                   '/画师选集/YogurtWZI/18+','/画师选集/グムラット Goomrrat/18+','/画师选集/パール/18+',
                    '/画师选集/ひづるめ/18+','/画师选集/フェルティア/18+','/画师选集/みるふぁー/18+',
                     '/画师选集/荻pote/18+','/画师选集/东山/18+'],
